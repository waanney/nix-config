{
  ...
  programs.firefox = {
    ...
    package = pkgs.wrapFirefox pkgs.firefox-devedition-unwrapped {
      # These policies are specific and should be kept as they are.
      extraPolicies = {
    ...
    profiles.default = {
      ...
      search.force = true;
      # The user's custom search engines are important for their workflow.
      search.engines = {
        "Home Manager NixOs" = {
          urls = [
            {
      ...
      settings = {
        # Removed redundant settings already covered by extraPolicies.
        # "extensions.pocket.enabled" = false;
        # "identity.fxaccounts.enabled" = false;
        # "toolkit.telemetry.enabled" = false;

        # The following settings are either important for privacy/security or
        ...
        # Thêm domain của ChatGPT vào danh sách ngoại lệ
        "network.http.referer.userControlPolicy" = 2;
        "network.http.referer.userControlList" = "openai.com";
